...
set linkflags= ^
User32.lib gdi32.lib Opengl32.lib Ws2_32.lib UxTheme.lib Crypt32.lib Wldap32.lib Normaliz.lib Shlwapi.lib Ole32.lib advapi32.lib dwmapi.lib Comdlg32.lib Shell32.lib Shcore.lib ..\dev\lib\freetype.lib
