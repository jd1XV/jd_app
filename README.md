...
- Compile your program by running build.bat. Compile or recompile your dynamic code by running build_lib.bat (dynamic). Note: You will need to run vcvarsall.bat or use the MSVC developer console to access the MSVC compiler. See [here](https://learn.microsoft.com/en-us/cpp/build/building-on-the-command-line?view=msvc-170) for more info.
