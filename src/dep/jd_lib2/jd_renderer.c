...
void jd_ShaderCreate(jd_Renderer* renderer) {
    jd_String fs_string = jd_DiskFileReadFromPath(renderer->arena, jd_StrLit("../src/dep/jd_lib2/resources/shaders/glsl/2d_fs.glsl"), true);
    jd_String vs_string = jd_DiskFileReadFromPath(renderer->arena, jd_StrLit("../src/dep/jd_lib2/resources/shaders/glsl/2d_vs.glsl"), true);
